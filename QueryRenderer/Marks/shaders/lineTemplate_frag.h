...
const std::string LineTemplate_Frag::source =
    ...
    "layout(location = 1) out uint finalIdA;\n"
    "layout(location = 2) out uint finalIdB;\n"
    ...
    "  uvec2 vals = unpackUint2x32(fPrimitiveId + 1);\n"
    "  finalIdA = vals[0];\n"
    "  finalIdB = vals[1];\n"
    "#elif inTidEnum == INT64_NV\n"
    "  ivec2 vals = unpackInt2x32(fPrimitiveId + 1);\n"
    "  finalIdA = uint(vals[0]);\n"
    "  finalIdB = uint(vals[1]);\n"
    "#else\n"
    "  finalIdA = fPrimitiveId + 1;\n"
    "  finalIdB = 0;\n"
    "#endif\n"
    "#elif useUid == 1\n"
    "#if inTidEnum == UNSIGNED_INT64_NV\n"
    "  uvec2 vals = unpackUint2x32(id + 1);\n"
    "  finalIdA = vals[0];\n"
    "  finalIdB = vals[1];\n"
    "#elif inTidEnum == INT64_NV\n"
    "  ivec2 vals = unpackInt2x32(id + 1);\n"
    "  finalIdA = uint(vals[0]);\n"
    "  finalIdB = uint(vals[1]);\n"
    "#else\n"
    "  finalIdA = id + 1;\n"
    ...
    "#if inTidEnum == UNSIGNED_INT64_NV\n"
    "  uvec2 vals = unpackUint2x32(lineData.<id> + 1);\n"
    "  finalIdA = vals[0];\n"
    "  finalIdB = vals[1];\n"
    "#elif inTidEnum == INT64_NV\n"
    "  ivec2 vals = unpackInt2x32(lineData.<id> + 1);\n"
    "  finalIdA = uint(vals[0]);\n"
    "  finalIdB = uint(vals[1]);\n"
    "#else\n"
    "  finalIdA = lineData.<id> + 1;\n"
    "  finalIdB = 0;\n"
    "#endif\n"
    "#endif\n"
    "\n"
