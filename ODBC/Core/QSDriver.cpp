...
// Public ==========================================================================================
////////////////////////////////////////////////////////////////////////////////////////////////////
QSDriver::QSDriver() : DSIDriver(), m_driverLog(new DSIFileLogger("mapd_driver.log")) {
...
void QSDriver::SetDriverPropertyValues() {
  ...
  SetProperty(DSI_DRIVER_DRIVER_NAME, AttributeData::MakeNewWStringAttributeData("MapD"));

  // The default encoding used for string data and input/output parameter values.
  SetProperty(DSI_DRIVER_STRING_DATA_ENCODING, AttributeData::MakeNewInt16AttributeData(ENC_UTF8));

// The default encoding used for wide string data and input/output parameter values.
#if (1 == PLATFORM_IS_LITTLE_ENDIAN)
  SetProperty(DSI_DRIVER_WIDE_STRING_DATA_ENCODING, AttributeData::MakeNewInt16AttributeData(ENC_UTF16_LE));
#else
  SetProperty(DSI_DRIVER_WIDE_STRING_DATA_ENCODING, AttributeData::MakeNewInt16AttributeData(ENC_UTF16_BE));
#endif
}
