...
QSDataEngine::QSDataEngine(IStatement* in_statement, QuickstartSettings* in_settings)
    : DSIExtSqlDataEngine(in_statement), m_settings(in_settings) {
  ...
  if (in_settings->m_useTableCaching) {
    ...
    SetProperty(DSIEXT_DATAENGINE_TABLE_CACHING, AttributeData::MakeNewWStringAttributeData(L"Y"));
  }
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
DSIMetadataSource* QSDataEngine::MakeNewMetadataTable(DSIMetadataTableID in_metadataTableID,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
SharedPtr<DSIExtResultSet> QSDataEngine::OpenTable(const simba_wstring& in_catalogName,
  ...
  if (utilities.DoesTableExist(in_tableName)) {
    table = new QSTable(m_settings, GetLog(), in_tableName, m_statement->GetWarningListener(), IsODBCVersion3());
