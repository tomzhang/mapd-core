...
class QSConnection : public Simba::DSI::DSIConnection {
 ...
 public:
  ...
  virtual bool PromptDialog(Simba::DSI::DSIConnSettingResponseMap& io_connResponseMap,
  ...
  virtual void SetCustomProperty(simba_int32 in_key, Simba::Support::AttributeData* in_value);
  ...
  virtual void UpdateConnectionSettings(const Simba::DSI::DSIConnSettingRequestMap& in_connectionSettings,
