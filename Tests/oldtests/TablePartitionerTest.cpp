...
int main(void) {
  ...
  tablePartitionerTest.instanciate() ? PPASS("Instanciate") : PFAIL("Instanciate");
  tablePartitionerTest.createTableAndPartitioners() ? PPASS("Create Table and partitioners")
                                                    : PFAIL("Create Table and partitioners");
  tablePartitionerTest.insertIntoPartitioners() ? PPASS("Insert into partitioners") : PFAIL("Insert into partitioners");
