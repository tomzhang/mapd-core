...
const std::string MultiGpuComposite_frag::source =
    ...
    "        if (srcColor.a < 1.0) {\n"
    "          if (dstColor.a > 0.0) {\n"
    "            // unpremultiply since the color buffers would have pre-multiplied color\n"
    ...
    "    }\n"
    "\n"
    "    // unpremultiply as this pass is run with a blend that pre-multiplies the color\n"
    "    // Not doing this will result in darkened colors\n"
    "    dstColor.rgb /= dstColor.a;\n"
    "    color = dstColor;\n"
    "}\n"
    "\n"
